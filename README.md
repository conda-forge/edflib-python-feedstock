...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/edflib-python-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14641&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/edflib-python-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `edflib-python` can be installed with:

```
conda install edflib-python
```

It is possible to list all of the versions of `edflib-python` available on your platform with:
